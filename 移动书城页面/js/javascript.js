...
if (localStorage.btn_click) {
    document.getElementById("empty-car").style.display = "none";
    car_item[add].style.display = "block";
    car_item[add].getElementsByClassName("info")[0].getElementsByTagName("img")[0].src = books[add].thumbSrc;
    car_item[add].getElementsByClassName("info")[0].getElementsByTagName("h3")[0].innerHTML = books[add].bookName;
    car_item[add].getElementsByClassName("info")[0].getElementsByTagName("p")[0].innerHTML = books[add].content;
    document.getElementsByClassName("left")[add].getElementsByTagName("span")[0].innerHTML = "￥" + books[add].originalPrice;
    document.getElementsByClassName("left")[add].getElementsByTagName("span")[1].innerHTML = "￥" + books[add].presentPrice;
} else {
...
function is_checked(){
    if(flag % 2 == 0){
        car_item[add].getElementsByClassName("info")[0].getElementsByTagName("button")[0].style.backgroundColor = "blue";
        toal = toal + books[add].originalPrice;
    } else {
        car_item[add].getElementsByClassName("info")[0].getElementsByTagName("button")[0].style.backgroundColor = "white";
        toal = toal - books[add].originalPrice;
    }
    flag++; 
...
// 实现购物车页面功能按钮
var add_btn = document.getElementsByClassName("left-btn")[0].getElementsByTagName("button")[1];
var reduce_btn = document.getElementsByClassName("left-btn")[0].getElementsByTagName("button")[0];
var number = 1;
for (var i = 0; i < document.getElementsByClassName("left-btn").length; i++) {
    document.getElementsByClassName("left-btn")[i].getElementsByTagName("button")[1].onclick = function () {
        number++;
        document.getElementsByClassName("left")[add].getElementsByTagName("span")[2].innerHTML = "x " + number;
        document.getElementById("total-money").innerHTML = "￥" + (number * toal.toFixed(2));
    }
    ...
    document.getElementsByClassName("right-btn")[i].getElementsByTagName("button")[0].onclick = function () {
        car_item[add].style.display = "none";
        document.getElementById("empty-car").style.display = "block";
    }
}
